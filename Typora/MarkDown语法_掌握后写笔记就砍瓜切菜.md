...
>
>-   Ctrl+Shift+]
>-   新增多个层级就多敲几个Tab，删除多个层级就多敲几个Backspace
...
| 表情符号码             | emoji表情            | 表情符号码                       | emoji表情                      | 表情符号码        | emoji表情       |
| ---------------------- | -------------------- | -------------------------------- | ------------------------------ | ----------------- | --------------- |
| `:grinning:`           | :grinning:           | `:sweat_smile:`                  | :sweat_smile:                  | `:rofl:`          | :rofl:          |
| `:wink:`               | :wink:               | `:innocent:`                     | :innocent:                     | `:joy:`           | :joy:           |
| `:blush:`              | :blush:              | `:upside_down_face:`             | :upside_down_face:             | `:kissing_heart:` | :kissing_heart: |
| `:yum:`                | :yum:                | `:stuck_out_tongue_winking_eye:` | :stuck_out_tongue_winking_eye: | `:thinking:`      | :thinking:      |
| `:see_no_evil:`        | :see_no_evil:        | `:speak_no_evil:`                | :speak_no_evil:                | `:dash:`          | :dash:          |
| `:point_up_2:`         | :point_up_2:         | `:point_down:`                   | :point_down:                   | `:point_left:`    | :point_left:    |
| `:point_right:`        | :point_right:        | `:smirk:`                        | :smirk:                        | `:monkey:`        | :monkey:        |
| `:frowning_face:`      | :frowning_face:      | `:astonished:`                   | :astonished:                   | `:rainbow:`       | :rainbow:       |
| `:question:`           | :question:           | `:exclamation:`                  | :exclamation:                  | `:rainbow_flag:`  | :rainbow_flag:  |
| `:telephone_receiver:` | :telephone_receiver: | `:house:`                        | :house:                        | `:school:`        | :school:        |
| `:snail:`              | :snail:              | `:muscle:`                       | :muscle:                       | `:e-mail:`        | :e-mail:        |
| `:date:`               | :date:               | `:briefcase:`                    | :briefcase:                    | `:moneybag:`      | :moneybag:      |
| `:man_student:`        | :man_student:        | `:birthday:`                     | :birthday:                     | `:pushpin:`       | :pushpin:       |
| `:shit:`               | :shit:               | `:thumbsup:`                     | :thumbsup:                     | `:thumbsdown:`    | :thumbsdown:    |
| `:ok_hand:`            | :ok_hand:            | `:running:`                      | :running:                      | `:couple:`        | :couple:        |
| `:family:`             | :family:             | `:pray:`                         | :pray:                         | `:see_no_evil:`   | :see_no_evil:   |
| `:love_letter:`        | :love_letter:        | `:speech_balloon:`               | :speech_balloon:               | `:earth:`         | :earth_asia:    |
| `:hammer:`             | :hammer:             | `:mag_right:`                    | :mag_right:                    | `:alarm_clock:`   | :alarm_clock:   |
| `:watch:`              | :watch:              | `:chart_with_downwards_trend:`   | :chart_with_downwards_trend:   | `:bookmark_tabs:` | :bookmark_tabs: |
| `:page_with_curl:`     | :page_with_curl:     | `:calendar:`                     | :calendar:                     | `:trophy:`        | :trophy:        |
| `:dart:`               | :dart:               | `:art:`                          | :art:                          | `:rocket:`        | :rocket:        |

>   更多MarkDown表情符
>
>   请搜索:mag_right:`MarkDown表情大全`
